...
(function( $ ) {
  ...
  _create: function() {
    var self = this,
        ...
        container = $("#display_columns"); // EDIT, was: container = o.checkContainer ? $(o.checkContainer) : $('<div class="table-menu table-menu-hidden"><ul /></div>');      
    ...
    hdrCols.each(function(i){
      ...
      if ( !th.is("." + o.persist) ) {
        ...
        container.append(toggle); // EDIT, was: container.find("ul").append(toggle);      
