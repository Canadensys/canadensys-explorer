...
/* Add extension data */
INSERT INTO occurrence_extension(auto_id,dwca_id,sourcefileid,resource_uuid,ext_type,ext_data)
VALUES(
1,'ACAD-1','acad-specimens','db4f9560-9cca-11e4-89d3-123b93f75cba','Multimedia',
...
INSERT INTO occurrence(
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,syear,habitat,associatedmedia)
VALUES (
2,'E. C. Smith Herbarium (ACAD)','acad-specimens','db4f9560-9cca-11e4-89d3-123b93f75cba',
...
INSERT INTO occurrence_raw(
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,year,habitat,associatedmedia)
VALUES (
2,'E. C. Smith Herbarium (ACAD)','acad-specimens','db4f9560-9cca-11e4-89d3-123b93f75cba',
'ACAD-2','Myosotis arvensis','species','Canada','Nova Scotia','ACAD','10440',2013, 'On a lobster claw','http://procyon.acadiau.ca/ecsmith/cgi-bin/image.cgi?ECS019597,jpeg; http://procyon.acadiau.ca/ecsmith/cgi-bin/image.cgi?ECS019597.jpeg'
);
...
INSERT INTO occurrence(
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,syear,habitat)
VALUES (
3,'E. C. Smith Herbarium (ACAD)','acad-specimens','db4f9560-9cca-11e4-89d3-123b93f75cba',
...
INSERT INTO occurrence(
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,habitat,_class,_order,decimallatitude,decimallongitude,associatedSequences,hasassociatedsequences)
VALUES (
4,'TRT (TRT)','trt-specimens','f8d222ba-9cca-11e4-89d3-123b93f75cba',
...
INSERT INTO occurrence_raw(
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,habitat,_class,_order,decimallatitude,decimallongitude,associatedSequences)
VALUES (
4,'TRT (TRT)','trt-specimens','f8d222ba-9cca-11e4-89d3-123b93f75cba',
...
INSERT INTO occurrence(
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,occurrenceid,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,habitat,_class,_order,decimallatitude,decimallongitude)
VALUES (
5,'TRT (TRT)','trt-specimens','f8d222ba-9cca-11e4-89d3-123b93f75cba',
...
auto_id,datasetname,sourcefileid,resource_uuid,dwca_id,occurrenceid,scientificname,taxonrank,country,stateprovince,collectioncode,catalognumber,habitat,_class,_order,decimallatitude,decimallongitude)
VALUES (
6,'TRT (TRT)','trt-specimens','f8d222ba-9cca-11e4-89d3-123b93f75cba',
...
-- dwca_resource
INSERT INTO dwca_resource(id, sourcefileid,resource_uuid,name,archive_url)
...
-- resource_metadata
INSERT INTO resource_metadata (dwca_resource_id,resource_uuid)
